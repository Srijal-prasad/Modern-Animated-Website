  ...
  return (
    <div className='w-full flex gap-5 h-screen bg-zinc-900 p-20'>
       <div className='w-1/2 h-full flex flex-col justify-between font-["Founders_Grotesk_X-Condensed"]'>
          ...
          <h1 className='text-[8vw] uppercase leading-none  tracking-tighter'>Eye-</h1>
       ...
       <div className='w-1/2'>
       <h1 className='text-[6vw] font-semibold uppercase leading-none tracking-tighter font-["Founders_Grotesk_X-Condensed"]'>Presentations
       </h1>
          <div className='dets font-["Neue_Montreal"] mt-10'>
            <a className='block text-xl font-light' href='https://www.facebook.com/'>Facebook</a>
            <a className='block text-xl font-light' href='https://www.instagram.com/'>Instagram</a>
            <a className='block text-xl font-light' href='https://twitter.com/'>Twitter</a>
          </div>
